...
<body>
    ...
    <center>
        ...
        <hr>
        <table border="1" style="font-size: 16px" class="text-center" cellpadding="0" cellspacing="0" >
            <tr>
                <th colspan="2" rowspan="4"><img src="img/logoPRE.png" alt=""></th>
                <th colspan="8" class="amarillo" style="font-size: 26px">{{$grado}} ° {{$seccion}} - {{$nivel}}</th>
                <th  colspan="9" class="celeste" style="font-size: 26px">{{$bimestre}}° BIMESTRE</th>
            </tr>
            <tr>
                <td colspan="17" style="font-size: 26px" class="verde">RESULTADOS GENERALES DEL SIMULACRO N° {{$numero}}</td>
            </tr>
            <tr style="font-size: 12px" class="celeste">
                ...
                <td rowspan="6" ><b><p class="verticalText">HISTORIA<br>DEL<br>PERÚ</p></b></td>
