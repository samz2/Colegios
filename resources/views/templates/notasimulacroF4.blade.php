    ...
    <center>
        ...
        <table border="1" style="font-size: 12px;" class="text-center" cellpadding="0" cellspacing="0" >
            <tr>
                ...
                <td colspan="9" class="amarillo" width=300 style="font-size: 26px">{{$grado}} ° {{$seccion}} - {{$nivel}}</td>
                <td  colspan="11" class="celeste" style="font-size: 26px">{{$bimestre}}° BIMESTRE</td>
            </tr>
            <tr>
                <td colspan="20" style="font-size: 26px" class="verde">RESULTADOS GENERALES DEL SIMULACRO N° {{$numero}}</td>
            </tr>
            <tr style="font-size: 11px" class="celeste">
                ...
                <td rowspan="6" ><b><p class="verticalText">HISTORIA UNIVERSAL</p></b></td>
            ...
            <tr>
                <td width=40 class="fondo" style="font-size: 14px"><b>N°</b></td>
                <td class="text-left fondo" width=160 style="font-size: 14px"><b>APELLIDOS Y NOMBRES</b></td>
            </tr>
