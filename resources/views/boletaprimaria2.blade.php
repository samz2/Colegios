...
<body>
    ...
    <div class="container-fluid">
       ...
       <div class="row">
        ...
        <div class="row">
            <table border="1" cellpadding="0" cellspacing="0" class="text-center" style="font-size: 11px">
                <tr>
                ...
                <tr>
                    <td rowspan="20" class="fondo" width="50" style="font-size: 10px"><p class="verticalText"><b>MATEMÁTICAS</b></p></td>
                    ...
                    <td rowspan="20" style="font-size: 16px">{{$mateProm}}</td>
                ...
                <tr>
                    <td class="text-left">Piensa matemáticamente situaciones de forma y movimiento.</td>
                    <td>{{$b1[1][3]}}</td>
                    <td>{{$b2[1][3]}}</td>
                    <td>{{$b3[1][3]}}</td>
                    <td>{{$b4[1][3]}}</td>
                ...
                <tr>
                    <td class="fondo" rowspan="12"><p class="verticalText"><b>PERSONAL SOCIAL</b></p></td>
                    <td class="text-center fondo" rowspan="4"><p class="verticalText"><b>HISTORIA</b></p></td>
                    <td class="text-left">Afirma su identidad</td>
                    <td>{{$b1[12][1]}}</td>
                    <td>{{$b2[12][1]}}</td>
                    <td>{{$b3[12][1]}}</td>
                    <td>{{$b4[12][1]}}</td>
                    <td rowspan="4" style="font-size: 16px">{{$historiapProm}}</td> <!-- promedio -->
                    <td rowspan="12">{{$socialesProm}}</td>
                    <td rowspan="12">{{""}}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="text-left">Convive respetandose a si mismo y a los demás</td>
                    <td>{{$b1[12][3]}}</td>
                    <td>{{$b2[12][3]}}</td>
                    <td>{{$b3[12][3]}}</td>
                    <td>{{$b4[12][3]}}</td>
                ...
                <tr>
                    <td class="text-center fondo" rowspan="4"><p class="verticalText"><b>GEOGRAFÍA</b></p></td>
                    <td class="text-left">Afirma su identidad</td>
                    <td>{{$b1[14][1]}}</td>
                    <td>{{$b2[14][1]}}</td>
                    <td>{{$b3[14][1]}}</td>
                    <td>{{$b4[14][1]}}</td>
                    <td rowspan="4" style="font-size: 16px">{{$geografiaProm}}</td> <!-- promedio -->
                </tr>
                <tr>
                    <td class="text-left">Construye su corporeidad</td>
                    <td>{{$b1[14][2]}}</td>
                ...
                <tr>
                    <td class="text-center fondo" rowspan="4"><p class="verticalText"><b>PERSONAL</b></p></td>
                    <td class="text-left">Afirma su identidad</td>
                    <td>{{$b1[13][1]}}</td>
                    <td>{{$b2[13][1]}}</td>
                    <td>{{$b3[13][1]}}</td>
                    <td>{{$b4[13][1]}}</td>
                    <td rowspan="4">{{$historiauProm}}</td> <!-- promedio -->
                </tr>
                <tr>
                    <td class="text-left">Construye su corporeidad</td>
                    <td>{{$b1[13][2]}}</td>
                ...
                <tr>
                    <td rowspan="10" class="fondo" style="font-size: 10px"><p class="verticalText"><b>CIENCIA Y <br> AMBIENTE</b></p></td>
                    ...
                    <td rowspan="10" style="font-size: 16px">{{$cienciasProm}}</td>
                    <td rowspan="10" style="font-size: 16px"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                            <table  border="1" cellpadding="0" cellspacing="0" style="font-size:9px;text-align:center">
                                <tr>
                                    <td class="fondo" width="196" height="15"><b>ORDEN DE MÉRITO</b></td>
                                    <td width="22"><b>{{""}}</b></td>
                                    <td width="21"><b>{{""}}</b></td>
                                    <td width="20"><b>{{""}}</b></td>
                                    <td width="21"><b>{{""}}</b></td>
                                    <td class="fondo" width="79"><b>ANUAL</b></td>
                                    <td width="35"><b>{{""}}</b></td>
                                </tr>
                                <tr>
                                    <td class="fondo" width="196" height="15"><b>COMPORTAMIENTO</b></td>
                                    <td width="22"><b>{{""}}</b></td>
                                    <td width="21"><b>{{""}}</b></td>
                                    <td width="20"><b>{{""}}</b></td>
                                    <td width="21"><b>{{""}}</b></td>
        ...
        <div class="row">
            <table  border="1" cellpadding="0" cellspacing="0" style="font-size:9px;text-align:center">
                ...
                {{-- 
                    <td width="80"><b>MARQUE CON UNA X SEGÚN CORRESPONDA</b></td>
                    <td width="80"><b>Área o áreas que pasan al proceso de recuperación</b></td>
                    <tr>
                    <td width="150" height="auto">APROBADO</td>
                    <td width="80"></td>
                    <td width="80"></td>
                </tr>
                <tr>
                    <td width="150" height="auto">REQUIERE RECUPERACIÓN</td>
                    <td width="80"></td>
                    <td width="150"></td>
                </tr>
                <tr>
                    <td width="150" height="auto">DESAPROBADO</td>
                    <td width="80"></td>
                    <td width="80"></td>
                </tr> --}}
            </table>
