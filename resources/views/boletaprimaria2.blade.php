       ...
       <div class="row">
        ...
        <div class="row">
            <table border="1" cellpadding="0" cellspacing="0" class="text-center" style="font-size: 11px">
                ...
                <tr>
                    <td class="text-left">Produce textos escritos</td>
                    <td>{{"12"}}</td>
                    <td>{{"12"}}</td>
                    <td>{{"12"}}</td>
                    <td>{{"12"}}</td>
                ...
                <tr>
                    ...
                    <td>{{"12"}}</td>
                    <td rowspan="5" style="font-size: 16px">12</td>
                    <td rowspan="10" style="font-size: 16px">12</td>
                    ...
                    <td>
                            <table  border="1" cellpadding="0" cellspacing="0" style="font-size:9px;text-align:center">
                                <tr>
                                    ...
                                    <td width="22"><b>{{"12"}}</b></td>
                                    <td width="21"><b>{{"12"}}</b></td>
                                    <td width="20"><b>{{"12"}}</b></td>
                                    <td width="21"><b>{{"12"}}</b></td>
