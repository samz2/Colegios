	    ...
	    <div class="container-fluid"  id="cabecera" >
            <table border="1" class="text-center" style="font-size: 12px" cellpadding="0" cellspacing="0" >
                <tr>
                    ...
                    <td  colspan="10" class="celeste">{{datos.bimestre}}° BIMESTRE</td>
                </tr>
                <tr>
                    <td colspan="20">&nbsp;</td>
                </tr>
                <tr>
                    <td colspan="20" class="verdeopaco">RESULTADOS GENERALES DEL SIMULACRO N° {{datos.simulacro}}</td>
                </tr>
                <tr>
                    <td colspan="20">&nbsp;</td>
                </tr>
                ...
                <tr v-for="(a,index) in notas" :key="a.dni">
                    ...
                    <td><input type="text" size="3" @blur="validar(index)" v-model="a.historiauniversal" onkeypress='return solonumeros(event)' maxlength="2"></td>
      ...
      valnum(nota){
        ...
        sumar(index){
            ...
            this.notas[index].acumulado =   this.nonull(this.notas[index].rv) * this.p1+
                                            ...
                                            this.nonull(this.notas[index].historiauniversal) * this.p2;   
            this.notas[index].promediodec = Math.round((this.notas[index].acumulado/17) * 100)/100;  
        ...
        validar(index)
        {
            ...
            if(!this.valnum1(this.notas[index].geografia)){
                this.notas[index].geografia    = null;
            }
            ...
            if(!this.valnum1(this.notas[index].historiauniversal)){
                this.notas[index].historiauniversal    = null;
            }
            if(!this.valnum1(this.notas[index].geografia)){
